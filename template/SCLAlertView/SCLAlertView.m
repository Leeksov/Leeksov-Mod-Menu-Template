...
- (void)setupViewWindowWidth:(CGFloat)windowWidth
{
    ...
    _labelTitle.textColor = UIColorFromHEX(0x4D4D4D);
    _viewText.textColor = UIColorFromHEX(0x4D4D4D);
    _contentView.layer.borderColor = UIColorFromHEX(0xCCCCCC).CGColor;
}
- (void)setupNewWindow {
...
{
    self.view.transform = CGAffineTransformConcat(CGAffineTransformIdentity, CGAffineTransformMakeScale(3.0f, 3.0f));
    self.view.alpha = 0.0f;
    [UIView animateWithDuration:0.3f animations:^{
        self.backgroundView.alpha = self.backgroundOpacity;
